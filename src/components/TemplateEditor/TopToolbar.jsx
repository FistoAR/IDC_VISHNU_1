    ...
    >
      ...
      <div className="flex items-center justify-end w-1/4">
        <div className="flex items-center bg-gray-100 rounded-lg p-1" style={{ gap: '0.5vw' }}>
            ...
            <span className="font-medium text-gray-700 w-8 text-center" style={{ fontSize: '0.8vw', minFontSize: '12px' }}>
            ...
            <button 
                onClick={() => handleZoom && handleZoom(100)}
...
// Start Helper for Zoom Level Display (1x = 100%)
const zoomLevel = 1; // Placeholder, real prop is 'zoom' but I need to map it visually if needed. 
