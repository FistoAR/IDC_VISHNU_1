...
const ImageEditor = ({ selectedElement, onUpdate, onPopupPreviewUpdate }) => {
  ...
  const galleryImages = [
    ...
    {
      name: "AI",
      url: "https://plus.unsplash.com/premium_photo-1764695426527-8f344be39993?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      name: "Operator",
  ...
  // Reset uploadedImages when selectedElement changes (handles undo/redo)
  useEffect(() => {
    if (selectedElement) {
      // Reset to default uploaded images when element is selected
      // This ensures undo/redo properly reflects the state
      setUploadedImages([
        {
          name: "Study Materials",
          url: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6",
  ...
  const handleFileUpload = (e) => {
    ...
    // Pop the crop modal for the new image immediately
    setCurrentCropSrc(imageUrl);
  ...
  useEffect(() => {
    applyVisuals();
  }, [filters, activeEffects, effectSettings, opacity, imageType]);

  const updateRadius = (corner, value) => {
    const val = Math.max(0, Number(value) || 0);
    const next = isRadiusLinked
  ...
  const RadiusBox = ({ corner, value, radiusStyle }) => (
    <div
      className={`relative flex items-center bg-white border border-gray-200 ${radiusStyle} w-24 h-12 shadow-sm px-2`}
    >
  ...
  const EffectControlRow = ({ label, value, onChange }) => (
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center border border-gray-200 rounded-lg px-1.5 py-1 w-20">
        <button onClick={() => onChange(value - 1)} className="text-gray-400">
          <ChevronLeft size={12} />
        </button>
        <input
          type="number"
          ...
          className="w-full text-center text-[11px] font-bold outline-none"
        />
        <button onClick={() => onChange(value + 1)} className="text-gray-400">
  ...
  return (
    <div className="relative flex flex-col gap-4 w-full max-w-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between relative z-20">
                ...
                <div className="relative">
                  <button
                    onClick={() =>
                      setShowImageTypeDropdown(!showImageTypeDropdown)
                    }
                    onBlur={() =>
                      setTimeout(() => setShowImageTypeDropdown(false), 200)
                    }
              ...
              <div className="flex items-center gap-3">
                <div
                  onClick={() => {
                    setCurrentCropSrc(selectedElement.src);
                    setIsCropModalOpen(true);
                  }}
                  className="w-18 h-18 rounded-xl overflow-hidden border-2 border-dashed bg-gray-50 cursor-pointer hover:border-indigo-400 group relative transition-all"
                  title="Click to Crop"
                >
                  <img
                ...
                <div
                  ...
                  className="flex-1 h-18 border-2 border-dashed bg-gray-50 rounded-xl flex flex-col items-center justify-center cursor-pointer"
                >
                  <Upload size={18} className="text-500 mb-1" />
                  <p className="text-[10px] text-gray-400 font-medium text-center">
                    Drag & Drop or{" "}
                    <span className="font-bold text-indigo-600">Upload</span>
                  </p>
                </div>
              </div>
              ...
              <button
                ...
                className="pop-crop-trigger w-full py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-[13px] font-bold text-gray-700 hover:bg-gray-100 transition-all flex items-center justify-center gap-2 mb-2 shadow-sm"
              >
              ...
              >
                <div className="grid grid-cols-3 gap-2 p-2 opacity-40">
                  {galleryImages.slice(0, 6).map((img, i) => (
                    <div key={i} className="flex flex-col gap-1">
                      ...
                      <span className="text-[8px] text-center text-gray-500 font-medium truncate">
                        {img.name}
                      </span>
                    </div>
                  ))}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/30 to-transparent flex items-end justify-center pb-5 ">
                  <div className="flex items-center gap-2 text-white">
                    ...
                    <span className="font-bold text-[15px] text-base tracking-tight">
                      Image Gallery
                    </span>
                  </div>
                </div>
            ...
            <div className="space-y-3">
              <div className="border border-gray-100 rounded-xl overflow-hidden shadow-sm bg-white">
                <button
                  onClick={() =>
                    setOpenSubSection(
                      openSubSection === "adjustments" ? null : "adjustments",
                    )
                  }
                ...
                >
                  ...
                  <ChevronDown
                    size={16}
                    className={`text-gray-400 transition-transform duration-200 ${openSubSection === "adjustments" ? "rotate-180" : ""}`}
                  />
                </button>
                    ...
                    {[
                      ...
                      <div key={key} className="space-y-2">
                        ...
                        <input
                          ...
                          style={{
                            background: `linear-gradient(to right, #6366f1 0%, #6366f1 ${((filters[key] - min) / (max - min)) * 100}%, #f3f4f6 ${((filters[key] - min) / (max - min)) * 100}%, #f3f4f6 100%)`,
                          }}
                        />
                      </div>
                    ))}
              ...
              <div className="border border-gray-100 rounded-xl overflow-hidden shadow-sm bg-white">
                <button
                  onClick={() =>
                    setOpenSubSection(
                      openSubSection === "radius" ? null : "radius",
                    )
                  }
                  className="w-full flex items-center justify-between px-4 py-3.5 text-[13px] font-bold text-gray-800"
                >
                  ...
                  <ChevronDown
                    size={16}
                    className={`text-gray-400 transition-transform duration-200 ${openSubSection === "radius" ? "rotate-180" : ""}`}
                  />
                </button>
                    ...
                    <div className="flex flex-col items-center gap-6">
                      ...
                      <div className="flex items-center gap-6">
                        <RadiusBox
                          corner="tl"
                          value={radius.tl}
                          radiusStyle="rounded-tl-[18px] rounded-tr-md rounded-br-md rounded-bl-md"
                        />
                        <RadiusBox
                          corner="tr"
                          value={radius.tr}
                          radiusStyle="rounded-tr-[18px] rounded-tl-md rounded-br-md rounded-bl-md"
                        />
                      </div>
                      ...
                      <div className="flex items-center gap-6">
                        <RadiusBox
                          corner="bl"
                          value={radius.bl}
                          radiusStyle="rounded-bl-[18px] rounded-tr-md rounded-br-md rounded-tl-md"
                        />
                        <RadiusBox
                          corner="br"
                          value={radius.br}
                          radiusStyle="rounded-br-[18px] rounded-tr-md rounded-tl-md rounded-bl-md"
                        />
                      </div>
                    </div>
                  </div>
              ...
              <div className="border border-gray-100 rounded-xl overflow-hidden shadow-sm bg-white">
                <button
                  onClick={() =>
                    setOpenSubSection(
                      openSubSection === "effect" ? null : "effect",
                    )
                  }
                  className="w-full flex items-center justify-between px-4 py-3.5 text-[13px] font-bold text-gray-800"
                >
                  ...
                  <ChevronDown
                    size={16}
                    className={`text-gray-400 transition-transform duration-200 ${openSubSection === "effect" ? "rotate-180" : ""}`}
                  />
                </button>
                  ...
                  <div className="p-4 pt-0 space-y-2 bg-white border-t border-gray-50">
                    {[
                      ...
                      <div key={eff} className="relative">
                        <div
                          className={`flex items-center justify-between p-3.5 rounded-xl border transition-all ${activePopup === eff ? "border-indigo-500 bg-indigo-50/20" : "bg-gray-50/80 border-gray-100"}`}
                        >
                          <span
                              ...
                              {eff.includes("Shadow") && (
                                <>
                                  <div className="flex items-start gap-4">
                                    <div
                                      ...
                                      style={{
                                        ...
                                        opacity:
                                          effectSettings[eff].opacity / 100,
                                      }}
                                    >
                                      ...
                                      <div>
                                        ...
                                        <div className="flex items-center justify-between border border-gray-200 rounded-xl px-3 py-2 bg-white relative">
                                          ...
                                          <div className="relative w-4 h-4 cursor-pointer">
                                            <Pipette
                                              size={14}
                                              className="text-gray-400 absolute inset-0 z-0 pointer-events-none"
                                            />
                                  ...
                                  <div className="space-y-4 pt-2">
                                    <EffectControlRow
                                      label="X Axis"
                                      value={effectSettings[eff].x}
                                      onChange={(v) =>
                                        updateEffectSetting(eff, "x", v)
                                      }
                                    />
                                    <EffectControlRow
                                      label="Y Axis"
                                      value={effectSettings[eff].y}
                                      onChange={(v) =>
                                        updateEffectSetting(eff, "y", v)
                                      }
                                    />
                                    <EffectControlRow
                                      label="Blur %"
                                      value={effectSettings[eff].blur}
                                      onChange={(v) =>
                                        updateEffectSetting(eff, "blur", v)
                                      }
                                    />
                                    <EffectControlRow
                                      label="Spread"
                                      value={effectSettings[eff].spread}
                                      onChange={(v) =>
                                        updateEffectSetting(eff, "spread", v)
                                      }
                                    />
                                  </div>
                                </>
      ...
      <CropModal
        ...
        imageSrc={currentCropSrc || selectedElement.src}
        onClose={() => {
          setIsCropModalOpen(false);
          setCurrentCropSrc(null);
        }}
        onConfirm={(croppedUrl) => {
          selectedElement.src = croppedUrl;
          setImageType("Crop");
          if (onUpdate) onUpdate();
          setCurrentCropSrc(null);
        }}
          ...
          {galleryView === "template" ? (
            <>
              <div className="flex px-4 pt-3 border-b bg-white">
                <button
                  ...
                  className={`flex-1 pb-2 text-[12px] font-bold transition-all ${activeTab === "gallery"
                ...
                <button
                  ...
                  className={`flex-1 pb-2 text-[12px] font-bold transition-all ${activeTab === "uploaded"
                    ? "border-b-2 border-black text-black"
                    : "border-transparent text-gray-400"
                    }`}
                >
              ...
              <div className="flex-1 overflow-y-auto px-8 py-6 custom-scrollbar">
                {activeTab === "uploaded" && (
                  <div className="mb-8">
                    <h3 className="text-[12px] font-bold text-black mb-6">
                      Upload you file
                    </h3>
                    <div
                      onClick={() => fileInputRef.current?.click()}
                    ...
                    >
                      <p className="text-[13px] text-gray-500 font-medium mb-3">
                        Drag & Drop or{" "}
                        <span className="text-[#5D38FF] font-bold">Upload</span>
                      </p>
                      <Upload
                        size={32}
                      ...
                      <p className="text-[11px] text-gray-400 font-medium">
                        Supported File :{" "}
                        <span className="uppercase">JPG, PNG</span>
                      </p>
                    </div>
                  </div>
                )}
                ...
                <div className="grid grid-cols-3 gap-x-4 gap-y-6">
                  {(activeTab === "gallery"
                    ...
                    <div
                      ...
                      onClick={() => {
                        setTempSelectedImage(img);
                      }}
                    >
                      <div
                        className={`aspect-square rounded-[4px] overflow-hidden border-2 transition-all ${tempSelectedImage?.name === img.name
                          ? "border-black"
                          : "border-transparent"
                          }`}
                      >
                      ...
                      <p
                        className="text-[11px] text-gray-500 mt-2 font-medium text-center leading-tight"
                        title={img.name}
                      >
                        {img.name.length > 18
                          ? img.name.slice(0, 11) + "..."
              ...
              <div className="p-3 border-t flex justify-center gap-2 bg-white">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setCurrentCropSrc(tempSelectedImage.url);
                    setIsCropModalOpen(true);
                  }}
                  className="flex-1 h-8 bg-gray-100 border border-gray-200 rounded-lg text-[11px] font-semibold flex items-center justify-center gap-1 hover:bg-gray-200 disabled:opacity-50"
                >
                  <Crop size={12} /> Crop
                </button>
                <button
            ...
            <>
              <div className="flex items-center gap-3 p-6 border-b border-gray-100">
                <button
                  onClick={() => setGalleryView("template")}
                  className="p-2 hover:bg-gray-50 rounded-lg transition-colors"
                >
                  <ArrowLeft size={20} className="text-black" />
                </button>
                <span className="font-bold text-black text-sg">
                  Image Properties
                </span>
              </div>
              ...
              <div className="p-6 border-t border-gray-100 flex gap-4 bg-white">
                <button
                  onClick={() => setGalleryView("template")}
                  className="flex-1 py-4 border-2 border-black rounded-xl text-[11px] font-bold text-black hover:bg-gray-50"
                >
                  Cancel
                </button>
                <button
